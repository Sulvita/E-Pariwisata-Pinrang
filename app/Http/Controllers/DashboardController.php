...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Mengambil data destinasi kuliner
        $destinasiBuatan = Destinasi::where('kategori', 'buatan')->get();
        $totalDestinasiBuatan = $destinasiBuatan->count();
        ...
        return view('dashboard', compact('destinasiWisata', 'totalDestinasiWisata', 'destinasiBuatan', 'totalDestinasiBuatan', 'destinasiHotel', 'totalDestinasiHotel', 'kebudayaan', 'totalKebudayaan'));
    }
}
