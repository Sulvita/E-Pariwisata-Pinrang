...
<div class="section bg-landing" id="Blog">
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <p class="text-center mb-7">Dengan fitur ini, semua orang
            ...
            <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('kreator.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class=" row mb-4">
                            <label for="inputName" class="col-md-3 form-label">Nama Wisata*</label>
                            <div class="col-md-9">
                        ...
                        <div class=" row mb-4">
                            <label for="kategori" class="col-md-3 form-label">Kategori Wisata*</label>
                            <div class="col-md-9">
                        ...
                        <div class="row mb-4">
                            <label class="col-md-3 form-label" for="nama">Kendaraan Akses</label>
                            <div class="col-md-9">
                        ...
                        <div class="row mb-4">
                            <label class="col-md-3 form-label" for="Sejarah">Sejarah Wisata </label>
                            <div class="col-md-9">
                                <input type="text" value="" name="Sejarah" id="Sejarah" class="form-control">
                                <small class="text-danger">Optional</small class="text-danger">
                            </div>
                        </div>

                        <div class=" row mb-4">
                            <label for="alamat" class="col-md-3 form-label">Alamat Wisata*</label>
                            <div class="col-md-9">
                        ...
                        <div class=" row mb-4">
                            <label for="tiket" class="col-md-3 form-label">Harga
                                Tiket</label>
                            <div class="col-md-9">
                                <input type="number" name="HargaTiket" class="form-control" id="tiket" placeholder="">
                                <small class="text-danger">Optional</small class="text-danger">
                            </div>
                        </div>
                        ...
                        <div class=" row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="time" name="JamBuka" class="form-control" id="tiket" placeholder="time">
                                <small class="text-danger">Optional</small class="text-danger">
                            </div>
                        </div>

                        <div class=" row mb-4">
                            <label for="jambuka" class="col-md-3 form-label">Fasilitas Wisata
                            </label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="FasilitasDestinasi" class="FasilitasDestinasi"
                                    placeholder="Fasilitas Destinasi" id="floatingTextarea2"
                        ...
                        <div class=" row mb-4">
                            <label for="jambuka" class="col-md-3 form-label">Deskripsi Wisata</label>
                            <div class="col-md-9">
                        ...
                        <div class=" row mb-4">
                            <label for="Lokasi" class="col-md-3 form-label">Lokasi Wisata*</label>
                            <div class="col-md-9">
                        ...
                        <div class=" row mb-4">
                            <label for="Lokasi  Penginapan Terdekat" class="col-md-3 form-label">Lokasi Penginapan
                                Terdekat</label>
                            <div class="col-md-9">
