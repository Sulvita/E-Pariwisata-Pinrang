...
@section('container')
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">Tambah Wisata Budaya</h1>
            <div>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Destinasi Wisata Budaya</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah Wisata Budaya</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('destinasi-kebudayaan.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">Pilih Lokasi Wisata Budaya</label>
...
@push('scripts')
    ...
    <script>
        ...
        function initMap() {
            ...
            mapPenginapan = L.map('mapPenginapan').setView([-4.3097, 119.9312],
            13); // Koordinat Kabupaten Soppeng, Sulawesi
        ...
        // ... tambahkan fungsi geocodeAlamat ...
