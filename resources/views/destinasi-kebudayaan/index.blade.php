...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">List Wisata Budaya</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Wisata Budaya </a></li>
                <li class="breadcrumb-item active" aria-current="page">List Wisata Budaya</li>
            </ol>
        </div>
    </div>
                    ...
                    <form action="{{ route('destinasi-kebudayaan.index') }}" method="GET">
                        <div class="input-group mb-3">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari Destinasi Kebudayaan">
                                ...
                                <div class="card"> <a href=""><img class="card-img-top"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <small class="d-block text-muted">{{
                                            \Carbon\Carbon::parse($kebudayaan->created_at)->locale('id')->diffForHumans()
                                            }}</small>
