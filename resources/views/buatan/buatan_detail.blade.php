    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <p class="text-justify"> {{ $destinasiBuatan->Deskripsi }}</p>
                        </div>
        ...
        <div class="col-12 col-md-4 mt-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pengunjung.destinasi.tambah-komentar', $destinasiBuatan) }}" method="POST">
                        @csrf
