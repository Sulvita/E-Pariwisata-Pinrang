                    ...
                    <div class="d-md-flex">
                        ...
                        <div class="ms-auto">
                            <a href="javascript:void(0);" class="d-flex mb-2">
                                ...
                                <div class=" mt-3 ms-1 text-muted font-weight-semibold">{{
                                    $destinasikebudayaan->totalKomentar()
                                    }} Komentar</div>
                            </a>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3">
                                <div class="d-flex align-items-center mb-3 mt-3">
                                    ...
                                    <div>
                                        <strong>Alamat : <br> {{ $destinasikebudayaan->alamat }}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="d-flex align-items-center mb-3 mt-3">
                                    ...
                                    <div>
                                        <strong>Jam Buka : <br> {{ $destinasikebudayaan->JamBuka }}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="d-flex align-items-center mb-3 mt-3">
                                    ...
                                    <div>
                                        <strong>Harga Tiket : <br> Rp.{{ $destinasikebudayaan->HargaTiket }}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="d-flex align-items-center mb-3 mt-3">
                                    ...
                                    <div>
                                        <strong>Fasilitas : <br> {{ $destinasikebudayaan->FasilitasDestinasi }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12 col-lg-6">
                                <div class="">
                                    ...
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ $destinasikebudayaan->latitude }},{{ $destinasikebudayaan->longitude }}"
                            ...
                            @if (!is_null($destinasikebudayaan->latitudepenginapan) &&
                            !is_null($destinasikebudayaan->longitudepenginapan))
                            <div class="col-12 col-lg-6">
                                <div class="">
                                    <span class="fw-bold me-2">Lokasi Penginapan Terdekat :</span>
                                    <div id="mappenginapan" style="height: 250px;"></div>
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ $destinasikebudayaan->latitudepenginapan }},{{ $destinasikebudayaan->longitudepenginapan }}"
                                        target="_blank" class="button-1 btn-sm mt-2 btn btn-primary block">Buka di
                                        Google Maps Browser</a>
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ $destinasikebudayaan->latitudepenginapan }},{{ $destinasikebudayaan->longitudepenginapan }}"
                                        target="_blank" class="button-2 btn-sm mt-2 btn block btn-primary">Buka di
...
<script>
    ...
    function initMappenginapan() {
        var latitudepenginapan = {{ $destinasikebudayaan->latitudepenginapan }};
        var longitudepenginapan = {{ $destinasikebudayaan->longitudepenginapan }};
