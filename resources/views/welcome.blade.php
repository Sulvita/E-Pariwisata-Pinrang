    ...
    <div class="page">
        <div class="page-main">
            ...
            <div class="landing-top-header overflow-hidden">
                ...
                <div class="demo-screen-headlin main-demo main-demo-1 spacing-to overflow-hidden reveal active"
                    id="home">
                    <div class="row">
                        <div class="col-12 col-xl-12 col-lg-12 my-auto">
                            <div class="image-container">
                                <img class="w-full centered-image" src="{{ asset('assets/images/banner/banner.jpg') }}"
                                    alt="">
                                        ...
                                        <div class="row mt-7">
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card overflow-hidden">
                                                    <img src="{{ asset('assets/images/banner/alam.jpg') }}"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="{{ route('pengunjung.destinasi.index') }}"
                                                            class="btn btn-primary">Jelajahi</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card overflow-hidden">
                                                    <img src="{{ asset('assets/images/banner/budaya.jpg') }}"
                                                        class="card-img-top" alt="img">
                                                    <div class="card-body">
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card overflow-hidden">
                                                    <img src="{{ asset('assets/images/banner/buatan.jpg') }}"
                                                        class="card-img-top" alt="img">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="{{ route('pengunjung.buatan.index') }}"
                                                            class="btn btn-primary">Jelajahi</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                                    ...
                                                    <div class="card-body px-1">
                                                        <div class="d-flex overflow-visible">
                                                            <a href="{{ route('destination.show', ['destination' => $destination->id]) }}"
                                                                ...
                                                                data-bs-image-src={{ asset('storage/' .
                                                                $destination->sampul) }}
                                                                style="background: url(&quot;{{ asset('storage/' .
                                                                $destination->sampul) }}&quot;) center center;"></a>
                                                            <div class="ps-3 flex-column">
                                                                <span
                                                                    class="badge bg-primary me-1 mb-1 mt-1 text-uppercase">{{
                                                                    $destination->kategori }}</span>
                                                                <h3><a
                                                                        href="{{ route('destination.show', ['destination' => $destination->id]) }}">{{
                                                                        $destination->nama }}</a>
                                                                </h3>
                                                                <p>Alamat: {{ $destination->alamat }}</p>
                                                                <p>Rating Rata-rata:
                                                                    {{ number_format($destination->komentars_avg_rating,
                                                                    2) }}
                                                                </p>
                                                                <a href="{{ route('destination.show', ['destination' => $destination->id]) }}"
                                        ...
                                        <div class="text-center d-flex justify-content-center mt-2">
                                            <a href="{{ route('semua.postingan') }}" class="btn btn-primary">Lihat Semua
                                                Postingan</a>
                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-9">
                                                                <h3 class="fw-semibold text-white">Memperluas Jangkauan
                                                                    ...
                                                                    <p class="text-white">Nikmati pengalaman perjalanan
                                                                        ...
                                                                        tersedia di dalamnya. Dengan fitur ini, semua
                                                                        orang
                                                            ...
                                                            <div class="col-lg-3 text-end my-auto">
                                                                <a class="modal-effect btn btn-primary w-lg pt-2 pb-2"
                                                                    href="{{ route('kreator.create') }}"><i
                                                                        class="fe fe-plus me-2"></i>Tambahkan
                                                                    Sekarang</a>
                                                            </div>
                                                        </div>
                                                    </div>
