                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="">
                                <div class="mt-2">
                                    <h6 class="text-center fw-bold">Total Wisata Alam </h6>
                                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="">
                                <div class="mt-2">
                                    <h6 class="text-center fw-bold">Total Wisata Buatan </h6>
                                </div>
                                <h2 class="mb-0 number-font text-center">{{ $totalDestinasiBuatan }}</h2>
                            </div>
                        </div>
                        <div class="card-footer">
                            <a href="{{ route('destinasi-buatan.index') }}" class="btn btn-primary btn-sm btn-block">Lihat Destinasi Buatan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="">
                                <div class="mt-2">
                                    <h6 class="text-center fw-bold">Total Wisata Budaya </h6>
                                </div>
