                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img class="d-block w-100 br-5" alt=""
                                    src="{{ asset('storage/' . $destination->sampul) }}" data-bs-holder-rendered="true">
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <h5>Deskripsi : </h5>
                                <p class="text-justify text-indent"> {{ $destination->Deskripsi }}</p>
                                <h5 class="mt-4">Sejarah : </h5>
                                <p class="text-justify text-indent"> {{ $destination->Sejarah }}</p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="d-flex align-items-center mb-3 mt-3">
                                        ...
                                        <div>
                                            <strong>Dapat Diakses Dengan : {{ $destination->akses }} </strong>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-4">
                                ...
                                @if (!is_null($destination->latitudepenginapan) && !is_null($destination->longitudepenginapan))
                                    <div class="col-12 col-lg-6">
                                        <div class="">
