                            ...
                            <div class="card-body">
                                <div class="vtimeline">
                                    <div class="timeline-wrapper timeline-wrapper-primary">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h6 class="timeline-title">Visi Misi Kabupaten Pinrang</h6>
                                            </div>
                                    ...
                                    <div class="timeline-wrapper timeline-inverted timeline-wrapper-danger">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h6 class="timeline-title">Deskripsi Kabupaten Pinrang</h6>
                                            </div>
                                            <div class="timeline-body">
                                                <p>{{ $item->Deskripsi }}</p>
                                            </div>
                                    ...
                                    <div class="timeline-wrapper timeline-wrapper-success">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h6 class="timeline-title">Sejarah Kabupaten Pinrang</h6>
                                            </div>
                                            <div class="timeline-body">
                                                <p>{{ $item->sejarah }}</p>
                                            </div>
                                    ...
                                    <div class="timeline-wrapper timeline-inverted timeline-wrapper-warning">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h6 class="timeline-title">Letak Geografis Kabupaten Pinrang</h6>
                                            </div>
                                            <div class="timeline-body">
                                                <p>{{ $item->geografis }}</p>
                                            </div>
