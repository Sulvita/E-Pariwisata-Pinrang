...
@section('container')
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">Tambah Wisata Alam</h1>
            <div>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Destinasi Wisata Alam</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah Wisata Alam</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('destinasi-wisata.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">Pilih Lokasi Wisata Alam</label>
