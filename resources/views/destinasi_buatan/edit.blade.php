...
@section('container')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">Edit Wisata Buatan</h1>
            <div>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Wisata Buatan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Wisata Buatan</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('destinasi-buatan.update', ['id' => $destinasiBuatan->id]) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control"
                                            value="{{ $destinasiBuatan->nama }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" id="alamat" class="form-control"
                                            value="{{ $destinasiBuatan->alamat }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="HargaTiket" placeholder="2000" id="HargaTiket"
                                            class="form-control" value="{{ $destinasiBuatan->HargaTiket }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="FasilitasDestinasi" id="FasilitasDestinasi" class="form-control" value=""> {{ $destinasiBuatan->FasilitasDestinasi }} </textarea>
                                    </div>
                                </div>

                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label for="Deskripsi">Deskripsi Wisata Buatan</label>
                                        <textarea name="Deskripsi" id="Deskripsi" class="form-control">{{ $destinasiBuatan->Deskripsi }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 sembunyi">
                                    <div class="form-group">
                                        ...
                                        @if ($destinasiBuatan->sampul)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $destinasiBuatan->sampul) }}"
                                ...
                                <div class="col-12 col-lg-6 sembunyi">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="latitudepenginapan" id="latitudepenginapan"
                                            class="form-control" value="{{ $destinasiBuatan->latitudepenginapan }}"
                                            readonly required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 sembunyi">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="longitudepenginapan" id="longitudepenginapan"
                                            ...
                                            value="{{ $destinasiBuatan->longitudepenginapan }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 sembunyi">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="latitude" id="latitude" class="form-control"
                                            value="{{ $destinasiBuatan->latitude }}" readonly required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 sembunyi">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="longitude" id="longitude" class="form-control"
                                            readonly value="{{ $destinasiBuatan->longitude }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary btn-block">Update Wisata Buatan</button>
                                </div>
        ...
        <script>
            ...
            var initialLatitudePenginapan = {{ $destinasiBuatan->latitudepenginapan ?? -3.7406 }};
            var initialLongitudePenginapan = {{ $destinasiBuatan->longitudepenginapan ?? 119.4786 }};
        ...
        <script>
            var map;
            var marker;
            var initialLatitude = {{ $destinasiBuatan->latitude }};
            var initialLongitude = {{ $destinasiBuatan->longitude }};
