                        ...
                        <li class="slide">
                            <a class="bok" data-bs-toggle="slide"
                                href="{{ route('pengunjung.destinasi.index') }}"><span
                                    class="side-menu__label">Wisata Alam</span></a>
                        </li>
                        <li class="slide">
                            <a class="bok" data-bs-toggle="slide"
                                href="{{ route('pengunjung.buatan.index') }}"><span
                                    class="side-menu__label">Wisata Buatan</span></a>
                        </li>
                        {{-- <li class="slide">
                        ...
                        <li class="slide">
                            <a class="bok" data-bs-toggle="slide"
                                href="{{ route('pengunjung.kebudayaan.index') }}"><span
                                    class="side-menu__label">Wisata Budaya</span></a>
                        </li>
                        <li class="slide">
