            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                        <i class="side-menu__icon fa fa-globe"></i><span class="side-menu__label"> Wisata Alam</span>
                        <i class="angle fe fe-chevron-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)"></a></li>
                        <li><a href="{{ route('destinasi-wisata.index') }}" class="slide-item">List  Wisata Alam</a></li>
                        <li><a href="{{ route('destinasi-wisata.create') }}" class="slide-item">Tambah  Wisata Alam</a></li>
                    </ul>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                        <i class="side-menu__icon fa fa-globe"></i><span class="side-menu__label">Wisata Buatan</span>
                        <i class="angle fe fe-chevron-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)"></a></li>
                        <li><a href="{{ route('destinasi-buatan.index') }}" class="slide-item">List Wisata Buatan</a></li>
                        <li><a href="{{ route('destinasi-buatan.create') }}" class="slide-item">Tambah Wisata Buatan</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                        <i class="side-menu__icon fa fa-globe"></i><span class="side-menu__label">Wisata Budaya</span>
                        <i class="angle fe fe-chevron-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)"></a></li>
                        <li><a href="{{ route('destinasi-kebudayaan.index') }}" class="slide-item">List Wisata Budaya </a></li>
                        <li><a href="{{ route('destinasi-kebudayaan.create') }}" class="slide-item">Tambah Wisata Budaya </a></li>
                    </ul>
                </li>
